...
import { EslinkTestService, MainService, RendererService } from './src/services/api-interfaces';
...
class ApiInitializer {
    ...
    public init(apiServices: MainService[]) {
        apiServices.forEach(service => {
            service.registerApiCollection(ipcMain, ipcRenderer);
        });
    }

}
// Initialize apis
(new ApiInitializer()).init([
    new EslinkTestService()
]);
// Run Code
(new Main()).init();

// ipcMain.handleOnce('preload', (event) => {
//     console.log('returning response to preload-request');
//     return JSON.parse(JSON.stringify(RendererService.preloadBridges));
// });
